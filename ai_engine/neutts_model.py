...
class VietnameseVoiceCloneEngine:
    ...
    def extract_profile(self, ref_audio_bytes: bytes, ref_text: str) -> dict:
        ...
        transcribe_result = self.whisper_model.transcribe(temp_ref_path, language="vi")
    ...
    # @modal.method()
    # def process(self, text: str, ref_audio_bytes: bytes, ref_text: str, temperature=0.7, top_k=40) -> bytes:
